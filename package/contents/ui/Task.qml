...
MouseArea {
    ...
    PlasmaCore.FrameSvgItem {
        ...
        anchors {
            ...
            topMargin: (!tasks.vertical && taskList.rows > 1) ? PlasmaCore.Units.smallSpacing / 4 : 2
            bottomMargin: (!tasks.vertical && taskList.rows > 1) ? PlasmaCore.Units.smallSpacing / 4 : 2
